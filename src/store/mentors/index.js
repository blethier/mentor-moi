...
const actions = {
  ...
  async loadOneMentor(context) {
    ...
    await axios.get(`https://mentor-moi-prod.herokuapp.com/api/mentor/${id}`, {
     headers: {
           // remove headers
         }
       }).then(res => {
...
await axios.post('https://mentor-moi-prod.herokuapp.com/api/user/register',userData)
.then(res => {
...
async updateMentor(context, data) {
  ...
  await axios.patch(`https://mentor-moi-prod.herokuapp.com/api/mentors/${id}`, mentorData, {
  headers: {
    // remove headers
  }
  }).then(res => {
...
await axios.post('https://mentor-moi-prod.herokuapp.com/api/user/login',userData)
.then(res => {
