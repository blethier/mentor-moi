<template>
    <div>
      <section class="text-red-300 lg:h-screen">
              ...
              <details class="mb-4">
               ...
               <details class="mb-4">
                ...
                <span class="text-lg">
                  ...
                  renseignez quelques réseaux ainsi qu'une chouette photo de profil. <br>
            ...
            <div class="w-full lg:w-1/2 px-4 py-2">
              <details class="mb-4">
                ...
                <span class="px-4 py-2 text-lg">
                  ...
                  développeurs expérimentés (mentors) et juniors (mentorés). 
                  Il permet aux mentorés de poser des questions, de demander des 
                  conseils ou de l'aide pour développer leurs compétences et leurs 
