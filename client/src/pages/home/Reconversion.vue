  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20">
      ...
      <p class="lg:w-1/2 w-full leading-relaxed ">
          ...
          on y retrouve conseils, retour d'épérience... <br />
    
        Si vous connaissez d’autres blogs de développeurs(euses), faites moi signe sur<a href="https://twitter.com/mans____m" target="blank" rel="noreferrer noopener" class="ml-3 text-xl font-black text-darkSands">Twitter</a>
