    ...
    <div class="px-5 py-24">
      <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
        ...
        <p>
          ...
          du site
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> l'identité
          des différents intervenants dans le cadre de sa réalisation et de son
          suivi :
        </p>
        <p>
          <strong>Propriétaire</strong> : Mahamat-salle Mansour – particulier –
          34170 Castelnau-le-Lez<br />
          <strong>Créateur</strong> :
          <a href="https://mansour-mahamat.netlify.app/">Mahamat-Salle</a><br />
          <strong>Responsable publication</strong> : Mahamat-Salle –
          mansour.mahamat.salle@gmail.com<br />
          Le responsable publication est une personne physique ou une personne
          morale.<br />
          <strong>Webmaster</strong> : Mahamat-Salle –
          mansour.mahamat.salle@gmail.com<br />
          <strong>Hébergeur</strong> : Netlify – 37 Albert Embankment London SE1
          7TL United Kingdom<br />
        ...
        <p>
          ...
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> implique
          ...
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> sont donc
        ...
        <p>
          ...
          décidée par Mahamat-salle Mansour, qui s’efforcera alors de
          communiquer préalablement aux utilisateurs les dates et heures de
          l’intervention.
        </p>
        <p>
          Le site
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> est mis à
          jour régulièrement par Mahamat-Salle. De la même façon, les mentions
        ...
        <p>
          Le site <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> a
          pour objet de fournir une information concernant l’ensemble des
          activités de la société.
        </p>
        <p>
          Mahamat-salle Mansour s’efforce de fournir sur le site
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> des
        ...
        <p>
          ...
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> sont
          données à titre indicatif, et sont susceptibles d’évoluer. Par
          ailleurs, les renseignements figurant sur le site
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> ne sont
        ...
        <p>
          Mahamat-salle Mansour est propriétaire des droits de propriété
        ...
        <p>
          ...
          préalable de : Mahamat-salle Mansour.
        </p>
        <p>
        ...
        <p>
          ...
          échéant, Mahamat-salle Mansour se réserve également la possibilité de
        ...
        <p>
          ...
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a>, peuvent
          êtres recueillies : l'URL des liens par l'intermédiaire desquels
          l'utilisateur a accédé au site
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a>, le
          fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet
          (IP) de l'utilisateur.
        </p>
        <p>
          En tout état de cause Mahamat-salle Mansour ne collecte des
        ...
        <p>
          ...
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> n'est
          ...
          rachat de Mahamat-salle Mansour et de ses droits permettrait la
        ...
        <p>
          Le site
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> contient
          un certain nombre de liens hypertextes vers d’autres sites, mis en
          place avec l’autorisation de Mahamat-salle Mansour. Cependant,
          Mahamat-salle Mansour n’a pas la possibilité de vérifier le contenu
          des sites ainsi visités, et n’assumera en conséquence aucune
          responsabilité de ce fait.
        </p>
        <p>
          La navigation sur le site
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> est
        ...
        <p>
          ...
          section "Confidentialité", cliquez sur Paramètres de contenu. Dans la
        ...
        <p>
          ...
          <a href="http://www.mentor-moi.com/">www.mentor-moi.com</a> est soumis
