  ...
  <div class="darkMode antialiased py-2 mb-6">
    <nav class="darkMode">
        ...
        <div class="relative flex items-center justify-between h-16">
          <div class="flex-1 flex items-center justify-center sm:items-stretch">
            <router-link to="/" class="flex-shrink-0 flex items-center">
              <img
                class="block lg:hidden mt-8 h-16 w-auto"
                src="../assets/img/minilogo.svg"
                alt="Workflow"
              />
              <img
          ...
          >
            <div v-if="isLoggedIn" class="ml-12 relative">
              <div class="hidden lg:block">
                <button
                  @click="toggleMenu"
                  class="lg:flex text-lg rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                  id="user-menu"
                  aria-haspopup="true"
                >
              ...
              <div
                ...
                class="invertedDarkMode z-50 origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5"
                role="menu"
              ...
              >
                <div class="px-2 pt-2 pb-3 space-y-1">
                  <router-link
                    v-if="!isMentor"
                    to="/register"
                    class="block px-4 py-2 hover:bg-sands"
                    role="menuitem"
                    >Devenir Mentor</router-link
                  >
                  <router-link
      ...
      <div
        ...
        class="fixed inset-x-0 bottom-16 z-50 bg-darkSands shadow"
      >
        <div @click="closeMenu" class="px-2 text-lg pt-2 pb-3 space-y-1">
          <router-link to="/jobs" class="block px-3 pb-2 rounded-md font-medium"
            >Emploi</router-link
          >
          <router-link
            to="/conseils"
            ...
            >Blog</router-link
          >
          <router-link to="/faq" class="block px-3 pt-2 rounded-md font-medium"
            >F.A.Q</router-link
          >
          <router-link
            class="block px-3 py-2 rounded-md font-medium"
      ...
      <div
        :class="openAccount ? 'block' : 'hidden'"
        class="fixed inset-x-0 bottom-16 z-50 bg-darkSands shadow"
      >
        <div @click="closeMenu" class="px-2 text-lg pt-2 pb-3 space-y-1">
          <router-link
          ...
          <p
            ...
            @click="logout"
            href="#"
            class="block px-4 pt-2 hover:bg-sands"
            role="menuitem"
          >
            Déconnexion
          </p>
          <router-link
            v-if="!isLoggedIn"
            to="/login"
            class="block px-4 py-6 hover:bg-sands"
            role="menuitem"
      ...
      <section
        ...
        class="block lg:hidden fixed inset-x-0 bottom-0 z-50 bg-darkSands shadow"
      >
        <div id="tabs" class="flex justify-between">
          ...
          >
            <svg
              ...
              height="25"
              viewBox="0 0 42 42"
              class="inline-block font-black mb-1"
            >
          ...
          >
            ...
            <span class="tab tab-explore block font-black text-base"
              >Mentors</span
            >
          </router-link>
          ...
          >
            ...
            <span class="tab tab-kategori block font-black text-base"
              >Autres</span
            >
          </a>
          ...
          >
            ...
            <span class="tab tab-account block font-black text-base"
              >Compte</span
            >
          </a>
        </div>
